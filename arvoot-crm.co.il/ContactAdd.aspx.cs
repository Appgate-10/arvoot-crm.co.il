...
{
    public partial class _contactAdd : System.Web.UI.Page
    {
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("Contact.aspx?ContactID=" + success.ToString());
            }
        }
        public long funcSave(object sender, EventArgs e)
        {
            ...
            else if(Phone2.Value != "" &&( Phone2.Value.Length < 9 || Phone2.Value.Substring(0, 1) != "0"))
            {
                ErrorCount++;
                FormError_label.Visible = true;
                FormError_label.Text = "יש להזין מספר טלפון תקין";
            ...
            else if(Helpers.insuredPhoneExist(Phone1.Value, -1 ) == "true")
            {
                ErrorCount++;
                FormError_label.Visible = true;
            ...
            else if(Tz.Value != "" && Helpers.insuredTzExist(Tz.Value, -1) == "true")
            {
                Div1.Visible = true;
                return 0;
            ...
            if (SelectHaveAsset.SelectedIndex == 0)
            {
                if (AssetValue.Value != "")
                {
                    ErrorCount++;
                    FormError_label.Visible = true;
                    FormError_label.Text = "עליך לסמן האם קיים נכס בבעלות הלקוח";
                    FormErrorBottom_label.Visible = true;
                    FormErrorBottom_label.Text = "עליך לסמן האם קיים נכס בבעלות הלקוח";
                    return 0;
            ...
            else if (SelectHaveAsset.SelectedIndex == 1)
            {
                if (AssetAddress.Value == "")
                {
                    ErrorCount++;
                    FormError_label.Visible = true;
                    FormError_label.Text = "עליך להזין כתובת נכס";
                    FormErrorBottom_label.Visible = true;
                    FormErrorBottom_label.Text = "עליך להזין כתובת נכס";
                    return 0;
                }
            }
            if (SelectHaveMortgageOnAsset.SelectedIndex == 0)
            {
                if (MortgageAmount.Value != "")
                {
                    ErrorCount++;
                    FormError_label.Visible = true;
                    FormError_label.Text = "עליך לסמן האם קיימת משכנתא על נכס";
                    FormErrorBottom_label.Visible = true;
                    FormErrorBottom_label.Text = "עליך לסמן האם קיימת משכנתא על נכס";
                    return 0;
                }
            ...
            else if (SelectHaveMortgageOnAsset.SelectedIndex == 1)
            {
                if (MortgageAmount.Value == "")
                {
                    ErrorCount++;
                    FormError_label.Visible = true;
                    FormError_label.Text = "עליך להזין גובה משכנתא";
                    FormErrorBottom_label.Visible = true;
                    FormErrorBottom_label.Text = "עליך להזין גובה משכנתא";
                    return 0;
                }
            }
            if (ErrorCount == 0)
