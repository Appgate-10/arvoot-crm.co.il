...
{
    public partial class _HouseHolds : System.Web.UI.Page
    {
        ...
        public void loadUsers(int page)
        {
            ...
            string sql = @" SELECT l.ID, l.Phone1, l.Tz, l.LastName, l.FirstName, 
                            FullName AS FullNameAgent,l.DateBirth,
                            CONVERT(varchar, l.CreateDate, 104) as CreateDate
                            FROM Lead l
                            LEFT JOIN Agent a ON l.AgentID = a.ID
                            WHERE l.IsContact = 1 and isnull(PartnerName,'') != ''";
